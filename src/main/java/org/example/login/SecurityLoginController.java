...
public class SecurityLoginController {
    ...
    public String authorizationFail() {
        return "authorization-fail"; // authorization-fail.html 또는 authorization-fail.jsp
    }

    @GetMapping("/security-login/authentication-fail")
    public String authenticationFail() {
        return "authentication-fail"; // authentication-fail.html 또는 authentication-fail.jsp
    }
}
